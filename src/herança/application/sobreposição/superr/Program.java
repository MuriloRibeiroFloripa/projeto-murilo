package herança.application.sobreposição.superr;

import herança.entities.sobreposição.superr.Account;
import herança.entities.sobreposição.superr.BusinessAccount;
import herança.entities.sobreposição.superr.SavingsAccount;
